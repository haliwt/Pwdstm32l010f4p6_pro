...
#define  POWER_ON()         HAL_GPIO_WritePin(POWER_GPIO_Port ,LED1_Pin,GPIO_PIN_SET)        // (PORTCbits.RC0= 1)
#define  POWER_OFF()        HAL_GPIO_WritePin(POWER_GPIO_Port ,LED1_Pin,GPIO_PIN_RESET)  ///  (PORTCbits.RC0 =0)
